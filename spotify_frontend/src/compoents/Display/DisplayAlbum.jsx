   ...
   <hr />
    {
      ...
      <>
        <div onClick={()=>playWithId(item.id)} key={index}  className='grid grid-col-3 sm:grid-4 gap-2 p-2 items-center text-[#a7a7a7] hover:bg-[#ffffff2b] cursor-pointer'>
